...
pkg_deps=(core/glibc core/util-linux)
...
do_prepare() {
  ...
  eval "$(perl -I$(pkg_path_for cerny-cc/intltool)/lib/lib/perl5 -Mlocal::lib=$(pkg_path_for cerny-cc/intltool)/lib)"
  #
  ...
  echo "--prefix=$pkg_prefix --disable-manpages --disable-man" > $HAB_CACHE_SRC_PATH/$pkg_dirname/.config.args
}
...
do_build() {
  export ACLOCAL_FLAGS="-I $(pkg_path_for core/pkg-config)/share/aclocal \
    -I$(pkg_path_for core/libtool)/share/aclocal \
    -I$(pkg_path_for cerny-cc/intltool)/share/aclocal \
