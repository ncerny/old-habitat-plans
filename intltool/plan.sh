...
pkg_version="0.40.6"
pkg_minor=${pkg_version:0:$(expr $pkg_version : '[0-9]*.[0-9]*')}
...
# required.
pkg_source="http://ftp.gnome.org/pub/gnome/sources/${pkg_name}/${pkg_minor}/${pkg_name}-${pkg_version}.tar.gz"
...
pkg_shasum="36cd8fe249d0cc20918b6d4583267208bf74c8d541c67a5fe63316846344f9f7"
...
do_prepare() {
  ...
  # eval "$(perl -I$(pkg_path_for core/expat) -Mlocal::lib=$(pkg_path_for core/expat)/lib -Mlocal::include=$(pkg_path_for core/expat)/include)"
